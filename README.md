...
THARINI MART is an ecommerce site developed using the MERN (MongoDB, Express.js, React, Node.js) stack. It offers a user-friendly and efficient shopping experience for customers, while providing sellers with essential tools to manage their products and sales.

## Features

- **User Registration:** Tharini Mart allows users to register as customers or sellers, enabling a tailored shopping experience.
...
- **Product Search:** Tharini Mart offers a search functionality where customers can find products by name or browse through categories such as Electronics, Clothes, Kitchen, and more.
...
```sh
git clone https://github.com/prashanth8054/assignment.git
```
