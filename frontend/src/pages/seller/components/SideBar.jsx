    ...
    return (
        <>
            <React.Fragment>
                ...
                >
                    <ListItemIcon>
                        <WidgetsIcon sx={{ color: (location.pathname === "/" || location.pathname === "/Seller/dashboard") ? '#2a387c' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <ShoppingCartIcon sx={{ color: location.pathname.startsWith('/Seller/products') ? '#2a387c' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <PendingActionsIcon sx={{ color: location.pathname.startsWith("/Seller/orders") ? '#2a387c' : 'inherit' }} />
                    </ListItemIcon>
                ...
                </ListItemButton>
                {
                    ...
                    >
                        <ListItemIcon>
                            <AdminPanelSettingsIcon sx={{ color: location.pathname.startsWith("/Seller/shopcart") ? '#2a387c' : 'inherit' }} />
                        </ListItemIcon>
            ...
            <React.Fragment>
                ...
                >
                    <ListItemIcon>
                        <AccountCircleIcon sx={{ color: location.pathname.startsWith("/Seller/profile") ? '#2a387c' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <LogoutIcon sx={{ color: location.pathname.startsWith("/logout") ? '#2a387c;' : 'inherit' }} />
                    </ListItemIcon>
